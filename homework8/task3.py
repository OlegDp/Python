...
print("{:<10} {:<20} {:<20} {:<20} {:<20}".format(*columns))

for i in rows[1:]:
    value = i.split(',')
    print("{:<10} {:<20} {:<20} {:<20} {:<20}".format(*value))
...
ship_mode = '''Standard,First,Second'''
sales = ' '
sales = str(round(x, 2)) + ',' + str(round(y, 2)) + ',' + str(round(b, 2))
print()
ship_rows = ship_mode.split('\n')
ship_columns = ship_rows[0].split(',')
print("{:<10} {:<10} {:<10}".format(*ship_columns))

sales_rows = sales.split('\n')
sales_columns = sales_rows[0].split(',')
print("{:<10} {:<10} {:<10}".format(*sales_columns))